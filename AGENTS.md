...
`practices/coding-practice.md` — Python engineering standards (style, typing, structure, testing). **Reference — read the relevant section on demand.**

### Security rules

`practices/security-practice.md` — Python security standards (injection, deserialization, subprocess, credentials). `/jk-security` reviews against these, and re-searches each run to catch what lands after today.
